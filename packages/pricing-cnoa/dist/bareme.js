...
exports.CATEGORY_CODES = exports.PHASE_C_PHOTOS_RATE = exports.PHASE_C_ON_SITE_RATE = exports.PHASE_B_RATE = exports.PHASE_A_RATE = exports.TVA_RATE = exports.HONORAIRES_RATE = exports.SECTION_LABELS = exports.BAREME_CNOA_2021 = void 0;
exports.estCategorieConnue = estCategorieConnue;
exports.categoriesDeSection = categoriesDeSection;
...
exports.HONORAIRES_RATE = 0.05;
exports.TVA_RATE = 0.2;
exports.PHASE_A_RATE = 0.4;
exports.PHASE_B_RATE = 0.3;
exports.PHASE_C_ON_SITE_RATE = 0.3;
exports.PHASE_C_PHOTOS_RATE = 0.1;
exports.CATEGORY_CODES = Object.keys(exports.BAREME_CNOA_2021);
function estCategorieConnue(code) {
    return Object.prototype.hasOwnProperty.call(exports.BAREME_CNOA_2021, code);
}
/** Catégories valides pour une section (alimente GET /p2/categories). */
function categoriesDeSection(section) {
    return exports.CATEGORY_CODES.filter((code) => exports.BAREME_CNOA_2021[code].validSections.includes(section));
}
