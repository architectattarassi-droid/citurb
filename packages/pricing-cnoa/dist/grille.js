...
exports.GRILLE_REELLE = void 0;
exports.niveauxDe = niveauxDe;
exports.estNiveauValide = estNiveauValide;
exports.fourchetteDe = fourchetteDe;
exports.basFourchette = basFourchette;
exports.plancherDe = plancherDe;
const bareme_1 = require("./bareme");
exports.GRILLE_REELLE = {
...
function niveauxDe(categorie) {
    return Object.keys(exports.GRILLE_REELLE[categorie].niveaux);
}
function estNiveauValide(categorie, niveau) {
    return Object.prototype.hasOwnProperty.call(exports.GRILLE_REELLE[categorie].niveaux, niveau);
}
function fourchetteDe(categorie, niveau) {
    const f = exports.GRILLE_REELLE[categorie].niveaux[niveau];
    return f ? [f[0], f[1]] : null;
}
/** Bas de fourchette = coût réel appliqué au devis. */
function basFourchette(categorie, niveau) {
    const f = exports.GRILLE_REELLE[categorie].niveaux[niveau];
    return f ? f[0] : null;
}
/**
 ...
 */
function plancherDe(categorie) {
    return bareme_1.BAREME_CNOA_2021[categorie].costPerM2;
}
