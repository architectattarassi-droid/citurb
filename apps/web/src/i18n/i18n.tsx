...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  // ─── Livraisons Matériaux (Tome 5) ─────────────────────────────────
  "liv.title":                      { fr: "Livraisons matériaux",            ar: "توصيلات المواد",          en: "Material deliveries" },
  "liv.new_command":                { fr: "Nouvelle commande",               ar: "طلب جديد",                en: "New order" },
  "liv.tab.pending":                { fr: "En attente",                       ar: "في الانتظار",             en: "Pending" },
  "liv.tab.confirmed":              { fr: "Confirmées",                       ar: "مؤكدة",                   en: "Confirmed" },
  "liv.tab.week":                   { fr: "Cette semaine",                    ar: "هذا الأسبوع",             en: "This week" },
  "liv.tab.received":               { fr: "Reçues",                           ar: "مستلمة",                  en: "Received" },
  "liv.tab.anomalies":              { fr: "Anomalies",                        ar: "الإشكالات",               en: "Anomalies" },
  "liv.status.request":             { fr: "Demandée",                         ar: "مطلوبة",                  en: "Requested" },
  "liv.status.confirmed":           { fr: "Confirmée",                        ar: "مؤكدة",                   en: "Confirmed" },
  "liv.status.en_route":            { fr: "En route",                         ar: "في الطريق",               en: "En route" },
  "liv.status.received":            { fr: "Reçue",                            ar: "مستلمة",                  en: "Received" },
  "liv.status.cancelled":           { fr: "Annulée",                          ar: "ملغاة",                   en: "Cancelled" },
  "liv.status.disputed":            { fr: "Litige",                           ar: "نزاع",                    en: "Disputed" },
  "liv.form.supplier":              { fr: "Fournisseur (User ID)",            ar: "المورّد (معرّف)",         en: "Supplier (User ID)" },
  "liv.form.delivery_date":         { fr: "Date de livraison souhaitée",     ar: "تاريخ التوصيل المطلوب",  en: "Requested delivery date" },
  "liv.form.address":               { fr: "Adresse chantier",                 ar: "عنوان الورش",             en: "Site address" },
  "liv.form.add_material":          { fr: "Ajouter un matériau",              ar: "إضافة مادة",              en: "Add material" },
  "liv.form.qty":                   { fr: "Qté",                              ar: "كمية",                    en: "Qty" },
  "liv.form.unit_price":            { fr: "PU MAD",                           ar: "ث/و درهم",                en: "Unit MAD" },
  "liv.form.subtotal_ht":           { fr: "Sous-total HT",                    ar: "المجموع الفرعي",          en: "Subtotal" },
  "liv.form.vat":                   { fr: "TVA 20%",                          ar: "ض.ق.م 20٪",              en: "VAT 20%" },
  "liv.form.total_ttc":             { fr: "Total TTC",                        ar: "المجموع الكلي",           en: "Total incl. VAT" },
  "liv.form.send":                  { fr: "Envoyer la commande",              ar: "إرسال الطلب",             en: "Send order" },
  "liv.action.receive":             { fr: "Réceptionner sur chantier",        ar: "استلام في الورش",        en: "Receive on site" },
  "liv.action.confirm":             { fr: "Confirmer la commande",            ar: "تأكيد الطلب",             en: "Confirm order" },
  "liv.action.reject":              { fr: "Refuser",                          ar: "رفض",                     en: "Reject" },
  "liv.action.mark_prete":          { fr: "Livraison prête (en route)",       ar: "جاهز للتوصيل",            en: "Mark as en route" },
  "liv.reception.title":            { fr: "Réception chantier",               ar: "استلام الورش",            en: "Site reception" },
  "liv.reception.step1":            { fr: "Photos camion + matériaux",        ar: "صور الشاحنة والمواد",    en: "Photos of truck + materials" },
  "liv.reception.take_photo":       { fr: "Prendre une photo",                ar: "التقاط صورة",             en: "Take a photo" },
  "liv.reception.step2":            { fr: "Vérification par ligne",           ar: "التحقق سطر بسطر",         en: "Per-line verification" },
  "liv.reception.ok":               { fr: "OK conforme",                      ar: "مطابق",                   en: "OK conforming" },
  "liv.reception.anomalie":         { fr: "Anomalie",                         ar: "إشكال",                   en: "Anomaly" },
  "liv.reception.step3":            { fr: "Signature chef chantier",          ar: "توقيع رئيس الورش",       en: "Site manager signature" },
  "liv.reception.clear_sig":        { fr: "Effacer la signature",             ar: "مسح التوقيع",             en: "Clear signature" },
  "liv.reception.validate":         { fr: "Valider la réception",             ar: "تأكيد الاستلام",          en: "Validate reception" },
  "liv.anomalie.type":              { fr: "Type d'anomalie",                  ar: "نوع الإشكال",             en: "Anomaly type" },
  "liv.anomalie.description":       { fr: "Description",                      ar: "الوصف",                   en: "Description" },
  "liv.anomalie.qty_missing":       { fr: "Quantité manquante",               ar: "كمية ناقصة",              en: "Quantity missing" },
  "liv.anomalie.qty_excess":        { fr: "Quantité excédentaire",            ar: "كمية زائدة",              en: "Quantity excess" },
  "liv.anomalie.quality":           { fr: "Problème qualité",                 ar: "مشكلة جودة",              en: "Quality issue" },
  "liv.anomalie.broken":            { fr: "Casse / endommagement",            ar: "كسر / تلف",               en: "Broken / damaged" },
  "liv.anomalie.non_conform":       { fr: "Matériau non conforme",            ar: "مادة غير مطابقة",         en: "Non-conforming material" },
  "liv.anomalie.late":              { fr: "Retard livraison",                 ar: "تأخر التوصيل",            en: "Late delivery" },
  "liv.calendar.title":             { fr: "Calendrier livraisons",            ar: "جدول التوصيلات",         en: "Delivery calendar" },
  "liv.calendar.week_prev":         { fr: "Sem. préc.",                       ar: "الأسبوع السابق",         en: "Prev week" },
  "liv.calendar.today":             { fr: "Aujourd'hui",                      ar: "اليوم",                   en: "Today" },
  "liv.calendar.week_next":         { fr: "Sem. suiv.",                       ar: "الأسبوع التالي",         en: "Next week" },
  "liv.empty":                      { fr: "Aucune commande dans cet onglet.", ar: "لا توجد طلبات هنا.",     en: "No orders in this tab." },
  "liv.refresh":                    { fr: "Rafraîchir",                       ar: "تحديث",                   en: "Refresh" },
  "liv.audit":                      { fr: "Audit",                            ar: "المراجعة",                en: "Audit" },
};
