    ...
    <div style={{ maxWidth:640 }}>
      <div style={{ marginBottom:32 }}>
        ...
        <h1 style={{ fontFamily:"var(--font-display)",fontSize:28,fontWeight:800,color:"var(--c-ink)",marginBottom:12,lineHeight:1.15 }}>
          Porte 3 — Réalisation clé en main (MOD)
        </h1>
        <p style={{ fontSize:15,color:"var(--c-muted)",lineHeight:1.7 }}>Pilotage chantier, sélection entreprises, contrôle qualité, suivi budget et délais.</p>
      </div>
      <div style={{ padding:28,background:"var(--c-soonSoft)",border:"1px solid rgba(124,58,237,.15)",borderRadius:16,marginBottom:24 }}>
        ...
        <a href="https://wa.me/212700127892?text=Salam%20Yassine%2C%20je%20suis%20int%C3%A9ress%C3%A9%20par%20la%20Porte%203%20%E2%80%94%20Réalisation clé en main (MOD)" target="_blank" rel="noopener"
      ...
      <div style={{ padding:20,background:"var(--c-card)",border:"1px solid var(--c-line)",borderRadius:12,fontSize:13,color:"var(--c-muted)",lineHeight:1.6 }}>
        ...
        Pilotage chantier, sélection entreprises, contrôle qualité, suivi budget et délais. Toute l'infrastructure de gestion de dossier, suivi et preuves opposables est en place — l'interface sera ouverte progressivement.
      </div>
    </div>
  );
}
