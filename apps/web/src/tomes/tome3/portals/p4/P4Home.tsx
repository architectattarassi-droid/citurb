  ...
  return (
    <div style={{ maxWidth:640 }}>
      <div style={{ marginBottom:32 }}>
        ...
        <p style={{ fontSize:15,color:"var(--c-muted)",lineHeight:1.7 }}>Analyse foncière, potentiel réglementaire, scénarios de valorisation, risques identifiés.</p>
      </div>
      <div style={{ padding:28,background:"var(--c-soonSoft)",border:"1px solid rgba(124,58,237,.15)",borderRadius:16,marginBottom:24 }}>
        ...
        <a href="https://wa.me/212700127892?text=Salam%20Yassine%2C%20je%20suis%20int%C3%A9ress%C3%A9%20par%20la%20Porte%204%20%E2%80%94%20Investisseur & foncier" target="_blank" rel="noopener"
      ...
      <div style={{ padding:20,background:"var(--c-card)",border:"1px solid var(--c-line)",borderRadius:12,fontSize:13,color:"var(--c-muted)",lineHeight:1.6 }}>
        ...
        Analyse foncière, potentiel réglementaire, scénarios de valorisation, risques identifiés. Toute l'infrastructure de gestion de dossier, suivi et preuves opposables est en place — l'interface sera ouverte progressivement.
      </div>
    </div>
  );
}
