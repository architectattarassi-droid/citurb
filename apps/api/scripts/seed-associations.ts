...
const ASSOCIATIONS = [
  {
    ...
    description: "Syndicat national des architectes exerçant en secteur privé au Maroc. Défense de la profession, négociations honoraires barème CNOA, conditions d'exercice, formations continues.",
    cotisationAnnuelleMad: 1500,
    ...
    eligibilityCriteria: {
      ...
      "Cotisation annuelle": "1 500 MAD/an — incluant assurance RC pro syndicale",
    },
  },
  {
    slug: "anjaum-jeunes-architectes",
    name: "ANJAUM — Association Nationale des Jeunes Architectes et Urbanistes du Maroc",
    description: "Réseau des jeunes architectes et urbanistes du Maroc (< 35 ans). Mentorat, formations continues, événements, partage de bonnes pratiques, accompagnement à l'installation.",
    cotisationAnnuelleMad: 300,
    ...
    eligibilityCriteria: {
      ...
      "Cotisation annuelle": "300 MAD (150 MAD pour étudiants)",
