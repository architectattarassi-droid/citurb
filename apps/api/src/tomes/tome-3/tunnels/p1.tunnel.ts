...
export const P1_TUNNEL_VERSION = "2026-02-15.v1.3";

export type P1PhaseId = string;
...
export type P1Phase = {
  ...
  // si cette phase est un alias d’une autre (itérations historiques)
  aliasOf?: string;
};

// Canon (IDs stables recommandés)
export const P1_PHASE_IDS_CANON = [
...
export const P1_PHASES: P1Phase[] = [
  {
  ...
  },
  {
    ...
    description:
      "Choisir l’offre: (A) Plan type + suivi photos chantier / (B) Plan personnalisé + suivi photos / (C) Plan personnalisé + suivi chantier personnalisé. Paiement = déclencheur (T1).",
  },
  {
    id: "P1_PH_ESQUISSE",
    label: "Esquisse",
    description:
      "Esquisse (plan type ou personnalisé) générée sous contraintes du cahier des charges / lotissement si renseigné.",
  ...
  },
  {
    ...
    description:
      "Validation MOA (et/ou cycles de modification selon pack commandé).",
  },
  {
    id: "P1_PH_AUTH_PLAN",
    label: "Version autorisation",
    description:
      "Production du plan autorisation (pièces réglementaires), prêt dépôt.",
  ...
  },
  {
    ...
    description:
      "Dépôt autorisation + tracking + journal probatoire.",
    unlockBy: { state: "E8" },
  },
  {
    id: "P1_PH_COMMISSION",
    label: "Commission",
    description:
      "Passage commission / suivi / délais surveillés (PMS).",
  },
  {
    id: "P1_PH_COMMISSION_RESULT",
    label: "Résultat commission",
    description:
      "Avis favorable/défavorable. En cas défavorable: itérations corrections jusqu’à 3 passages (au-delà: escalade MOA / avenant).",
  },
  {
    id: "P1_PH_COMMISSION_REMARKS",
    label: "Remarques commission",
    description:
      "Intégration des remarques (coupes, encorbellements, surfaces min, etc.) et régénération contrôlée.",
  ...
  },
  {
    ...
    description:
      "Signature autorisation (Barid e-sign/Rokhas) + archivage probatoire.",
  },
  {
    id: "P1_PH_OPEN_SITE",
    label: "Ouverture chantier",
    description:
      "Ouverture chantier + jalons: fondations, dalles, toiture.",
  },
  {
    id: "P1_PH_SITE_MONITORING",
    label: "Suivi chantier",
    description:
      "Suivi chantier (photos, PV, contrôles). Chaque passage = événement probatoire. Options selon pack.",
  ...
  },
  {
    ...
    label: "Archivage",
    description:
      "Dossier archivé (append-only) + scellés (hash).",
  },
  ...
  },
  {
    ...
    description:
      "Dossier d’exécution + détails + plans d’atelier si requis.",
  ...
  },
  {
    ...
    description:
      "Choisir une entreprise CITURBAREA ou intégrer votre entreprise dans le processus (contrats, planning, PV).",
  ...
  },
  {
    ...
    description:
      "Process BIM (IFC) + échanges + audit (clash report).",
  ...
  },
  {
    ...
    description:
      "Décoration & design intérieur: moodboards, variantes matériaux, validations.",
  ...
  },
  {
    ...
    description:
      "Commande matériaux via CITURBAREA + marge + traçabilité + livraison.",
  ...
  },
  {
    ...
    description:
      "Dossier bancaire prêt à déposer (après plan type/personnalisé) + courtier technique + banques partenaires + marge CITURBAREA.",
