...
exports.OgPrerenderMiddleware = void 0;
 ...
 */
let OgPrerenderMiddleware = class OgPrerenderMiddleware {
    articlesService;
    // Liste fermée des User-Agents des bots sociaux connus. Conservative pour
    // éviter de servir le HTML mini à un humain.
    BOT_REGEX = /facebookexternalhit|facebookcatalog|Facebot|whatsapp|Twitterbot|LinkedInBot|Slackbot|TelegramBot|Discordbot|Pinterest|redditbot|Applebot|Googlebot-Image|bingbot|DuckDuckBot|YandexBot|Embedly|Quora Link Preview|skypeuripreview|Iframely|Tumblr|vkShare|W3C_Validator/i;
    ...
    renderArticleOgHtml(a, req) {
        const protoHeader = req.headers["x-forwarded-proto"] || req.protocol || "https";
        const host = req.headers["x-forwarded-host"] || req.headers.host || "citurbarea.com";
...
exports.OgPrerenderMiddleware = OgPrerenderMiddleware;
exports.OgPrerenderMiddleware = OgPrerenderMiddleware = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [articles_service_1.ArticlesService])
], OgPrerenderMiddleware);
// ────────────────────────────────────────────────────────────────────────
// Helpers
// ────────────────────────────────────────────────────────────────────────
