...
exports.RAPPORT_PRET = exports.PACK_ACTIVE = exports.PAIEMENT_RECU = exports.DEMANDE_RECUE = exports.SHELL = exports.HTML_LANG = exports.DIR = exports.LANGS = void 0;
exports.normalizeLang = normalizeLang;
exports.LANGS = ["fr", "en", "ar"];
function normalizeLang(input) {
    const v = String(input ?? "").toLowerCase().slice(0, 2);
    return v === "en" || v === "ar" ? v : "fr";
}
exports.DIR = { fr: "ltr", en: "ltr", ar: "rtl" };
exports.HTML_LANG = { fr: "fr", en: "en", ar: "ar" };
// ────────────────────────────────────────────────────────────────
...
// ────────────────────────────────────────────────────────────────
exports.DEMANDE_RECUE = {
    subject: {
        fr: (porte) => `✓ Votre demande ${porte} est bien reçue — CITURBAREA`,
        en: (porte) => `✓ Your ${porte} request has been received — CITURBAREA`,
        ar: (porte) => `✓ تم استلام طلبك ${porte} — CITURBAREA`,
    },
    title: {
    ...
    preheader: {
        fr: (id) => `Référence dossier : ${id}…`,
        en: (id) => `Dossier reference: ${id}…`,
        ar: (id) => `مرجع الملف : ${id}…`,
    },
    hello: {
        fr: (n) => `Bonjour ${n}`,
    ...
    body: {
        fr: (porte) => `Nous avons bien reçu votre demande <strong>${porte}</strong> sur la plateforme CITURBAREA.`,
        en: (porte) => `We have received your <strong>${porte}</strong> request on the CITURBAREA platform.`,
        ar: (porte) => `لقد استلمنا طلبك <strong>${porte}</strong> على منصّة CITURBAREA.`,
    },
    projectLabel: {
        fr: "Projet",
        en: "Project",
...
exports.PAIEMENT_RECU = {
    ...
    preheader: {
        fr: (amt) => `${amt} · Validation admin sous 24h`,
        en: (amt) => `${amt} · Admin validation within 24h`,
        ar: (amt) => `${amt} · مصادقة الإدارة خلال 24 ساعة`,
    },
    body: {
        fr: (amt) => `Nous avons bien reçu votre paiement de <strong style="color:#34d399; font-size:18px;">${amt}</strong>.`,
        en: (amt) => `We have received your payment of <strong style="color:#34d399; font-size:18px;">${amt}</strong>.`,
        ar: (amt) => `لقد استلمنا أداءك بقيمة <strong style="color:#34d399; font-size:18px;">${amt}</strong>.`,
    },
    txRef: {
...
exports.PACK_ACTIVE = {
    subject: {
        fr: (porte) => `✅ Votre pack ${porte} est activé — CITURBAREA`,
        en: (porte) => `✅ Your ${porte} pack is activated — CITURBAREA`,
        ar: (porte) => `✅ تم تفعيل باقة ${porte} الخاصة بك — CITURBAREA`,
    },
    title: {
        fr: "Pack activé !",
        en: "Pack activated!",
    ...
    banner: {
        fr: (porte) => `🎉 <strong>Votre pack ${porte} est activé !</strong>`,
        en: (porte) => `🎉 <strong>Your ${porte} pack is activated!</strong>`,
        ar: (porte) => `🎉 <strong>تم تفعيل باقة ${porte} !</strong>`,
    },
    body: {
        fr: (ref) => `Votre dossier <strong>${ref}</strong> est maintenant opérationnel et notre équipe peut commencer à travailler dessus.`,
        en: (ref) => `Your dossier <strong>${ref}</strong> is now operational and our team can start working on it.`,
        ar: (ref) => `ملفّك <strong>${ref}</strong> أصبح جاهزاً، وفريقنا قادر على بدء العمل عليه.`,
    },
    nextStepsTitle: {
...
exports.RAPPORT_PRET = {
    ...
    body: {
        fr: (name) => `Votre rapport <strong>${name}</strong> a été finalisé par notre expert et est prêt à être téléchargé.`,
        en: (name) => `Your report <strong>${name}</strong> has been finalized by our expert and is ready for download.`,
        ar: (name) => `تقريرك <strong>${name}</strong> أنجزه خبيرنا وأصبح جاهزاً للتحميل.`,
    },
    ctaDownload: {
