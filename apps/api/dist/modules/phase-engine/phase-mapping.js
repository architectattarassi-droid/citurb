...
exports.LEGACY_TO_V7 = void 0;
exports.isLegacyCode = isLegacyCode;
exports.phaseVariants = phaseVariants;
exports.toV7 = toV7;
const common_1 = require("@nestjs/common");
const log = new common_1.Logger("PhaseMapping");
/**
 ...
 */
const V7_TO_LEGACY = Object.fromEntries(Object.entries(exports.LEGACY_TO_V7).map(([legacy, v7]) => [v7, legacy]));
/**
...
function toV7(code) {
    if (!isLegacyCode(code))
        return code; // déjà v7 ou code arbitraire non-legacy
    const v7 = exports.LEGACY_TO_V7[code];
    if (v7)
        return v7;
