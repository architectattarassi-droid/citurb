    ...
    computeNextAction(dossier, payload, phases, payments) {
        ...
        if (pvc?.active && pvc?.blocked) {
            return {
                ...
                description: "Aucun PV de visite depuis plus de 15 jours. Les commandes et l'affectation de sous-traitants sont suspendues jusqu'au dépôt d'un nouveau PV.",
