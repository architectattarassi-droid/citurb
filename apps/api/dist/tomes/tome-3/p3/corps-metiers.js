...
exports.GROUPES_LABELS = exports.CORPS_METIERS = void 0;
exports.maxCorpsMetiers = maxCorpsMetiers;
exports.listCorpsMetiersGrouped = listCorpsMetiersGrouped;
exports.CORPS_METIERS = [
 ...
 */
function maxCorpsMetiers() {
    return exports.CORPS_METIERS.length;
}
/**
 * Liste les corps de métiers groupés (pour formulaire wizard frontend).
 */
function listCorpsMetiersGrouped() {
    const result = {
        GROS_OEUVRE: [],
        SECOND_OEUVRE: [],
        FINITIONS: [],
    ...
    exports.CORPS_METIERS.forEach(c => result[c.groupe].push(c));
    return Object.entries(result).map(([groupe, items]) => ({
        groupe: groupe,
        label: exports.GROUPES_LABELS[groupe],
        items,
    }));
}
