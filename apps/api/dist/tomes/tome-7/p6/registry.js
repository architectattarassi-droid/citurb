...
exports.DOCUMENTS_REQUIS_FOURNISSEUR = exports.DOCUMENTS_REQUIS_PRESTATAIRE = exports.P6_STATUS_LABELS = exports.SPECIALITES_PRESTATAIRE = exports.CATEGORIES_AGREMENT = exports.CLASSES_BTP = exports.P6_TYPES = void 0;
exports.P6_TYPES = [
    {
        code: "PRESTATAIRE_SERVICE",
...
exports.CLASSES_BTP = [
    { code: "1", label: "Classe 1", caRange: "> 50 000 000 DH", level: "Très grand" },
    { code: "2", label: "Classe 2", caRange: "30 000 000 – 50 000 000 DH", level: "Grand" },
    { code: "3", label: "Classe 3", caRange: "15 000 000 – 30 000 000 DH", level: "Moyen-grand" },
    { code: "4", label: "Classe 4", caRange: "7 000 000 – 15 000 000 DH", level: "Moyen" },
    { code: "5", label: "Classe 5", caRange: "3 000 000 – 7 000 000 DH", level: "Petit-moyen" },
    { code: "6", label: "Classe 6", caRange: "1 000 000 – 3 000 000 DH", level: "Petit" },
    { code: "7", label: "Classe 7", caRange: "< 1 000 000 DH", level: "Très petit" },
];
exports.CATEGORIES_AGREMENT = [
    { code: "A", label: "A — Bâtiments", desc: "Construction et réhabilitation de bâtiments", subTypes: ["A.1 Gros œuvre", "A.2 Second œuvre", "A.3 Bâtiments tous corps d'état"] },
    { code: "B", label: "B — Travaux Publics", desc: "Routes, ponts, ouvrages d'art, terrassement", subTypes: ["B.1 Routes & autoroutes", "B.2 Ouvrages d'art", "B.3 Terrassement & VRD"] },
    { code: "C", label: "C — Spécialités techniques", desc: "Lots techniques (élec, plomberie, étanchéité, etc.)", subTypes: ["C.1 Électricité CF/CFa", "C.2 Plomberie sanitaire", "C.3 CVC", "C.4 Étanchéité", "C.5 Ascenseurs", "C.6 Sécurité incendie", "C.7 Photovoltaïque"] },
    { code: "D", label: "D — Études techniques (BET)", desc: "Bureaux d'études — calculs structure, fluides, thermique", subTypes: ["D.1 BET structure", "D.2 BET fluides", "D.3 BET thermique RT2020", "D.4 BET acoustique"] },
    { code: "E", label: "E — Contrôle technique (BC)", desc: "Bureaux de contrôle — visa technique, inspection", subTypes: ["E.1 BC bâtiment", "E.2 BC ouvrages d'art", "E.3 BC ascenseurs"] },
];
// ─── Spécialités prestataires (services hors BTP standard) ────────────
exports.SPECIALITES_PRESTATAIRE = [
...
exports.DOCUMENTS_REQUIS_PRESTATAIRE = [
...
exports.DOCUMENTS_REQUIS_FOURNISSEUR = [
    { slug: "cin_gerant", label: "CIN du gérant / représentant légal", obligatoire: true },
    { slug: "rc", label: "Registre du commerce (RC)", obligatoire: true },
