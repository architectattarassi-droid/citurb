...
exports.P4PricingService = void 0;
...
let P4PricingService = class P4PricingService {
    listPacks() {
        return Object.keys(PACK_DEFINITIONS).map(code => ({
            code,
    ...
    computeQuote(input) {
        ...
        if (!def)
            throw new Error(`Pack inconnu: ${input.pack}`);
...
exports.P4PricingService = P4PricingService;
exports.P4PricingService = P4PricingService = __decorate([
