...
exports.P1_UPSELLS = exports.P1_OFFERS = exports.P1_CATALOG_VERSION = void 0;
exports.P1_CATALOG_VERSION = "2026-02-15";
exports.P1_OFFERS = [
    {
        id: "P1_O1",
        title: "Plan type + suivi chantier photos",
        summary: "Pack d'entrée : plan type conforme + suivi photo/visites selon quota (preuves probatoires).",
        includes: [
            "Esquisse (plan type)",
    ...
    },
    {
        ...
        summary: "Pack standard : plan sur-mesure + cycles de révision inclus + suivi photo renforcé.",
        includes: [
    ...
    },
    {
        ...
        summary: "Pack premium : plan sur-mesure + suivi chantier structuré (visites, PV, jalons).",
        includes: [
            "Esquisse (plan personnalisé)",
            "Révisions incluses (C1/C2 selon scope)",
            "Version autorisation",
...
exports.P1_UPSELLS = [
    ...
    },
    {
        ...
        summary: "Collecte guidée + pré-score pour lancer un financement (après 1er plan).",
        entitlementType: "FINANCING_PREQUAL",
    },
    {
        id: "UPS_FINANCING_DOSSIER",
        title: "Dossier bancaire prêt à déposer (banques partenaires)",
        summary: "Génération du dossier bancaire + pack pièces (stockage privé) + transmission partenaire.",
    ...
    },
    {
        ...
        summary: "Shortlist entreprises, comparaison devis, intégration entreprise client, contrat via CITURBAREA.",
        entitlementType: "COMPANY_SELECTION",
    },
    {
        id: "UPS_BIM_IFC_COLLAB",
        title: "BIM/IFC — échanges & coordination",
        summary: "Process IFC, versions, checks, journal d'échanges (features débloquées par paiements).",
