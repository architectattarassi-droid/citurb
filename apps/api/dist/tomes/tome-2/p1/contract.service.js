...
exports.P1ContractService = void 0;
const common_1 = require("@nestjs/common");
const contract_service_1 = require("../p2/contract.service");
/**
 ...
 */
let P1ContractService = class P1ContractService {
    p2Contract;
    constructor(p2Contract) {
        this.p2Contract = p2Contract;
    }
    /**
     ...
     */
    buildContractData(dossier) {
        const payload = (dossier?.payload && typeof dossier.payload === "object") ? dossier.payload : {};
        const brief = payload.brief || {};
        const projet = payload.projet || brief.projet || {};
        // Surface plancher : priorité au champ explicite, sinon quoteSnapshot, sinon brief
        const surfacePlancherM2 = (typeof payload.surfacePlancher === "number" ? payload.surfacePlancher : undefined) ??
        ...
        const projectTypeLabel = (() => {
            ...
            if (t === "villa")
                return "Villa individuelle";
            if (t === "immeuble")
                return "Maison à étages (R+) — usage familial";
            if (t === "ferme_urbaine")
                return "Ferme urbaine";
            if (t === "renovation")
                return "Rénovation / Décoration";
     ...
     */
    renderConsentPage(dossierId, projectTitle) {
...
exports.P1ContractService = P1ContractService;
exports.P1ContractService = P1ContractService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [contract_service_1.P2ContractService])
], P1ContractService);
